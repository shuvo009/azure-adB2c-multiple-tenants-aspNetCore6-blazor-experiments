...
public class UserService : IUserService
{
    ...
    public Task Delete(string userId, string tenantName)
    {
        var client = GetClient(tenantName);
        return client.Users[userId].Request().DeleteAsync();
    }

    public async Task UpdatePassword(string userId, string tenantName, string password)
    {
        var client = GetClient(tenantName);
        await client
           .Users[userId]
...
public interface IUserService
{
    ...
    Task Delete(string userId, string tenantName);
    Task UpdatePassword(string userId, string tenantName, string password);
}